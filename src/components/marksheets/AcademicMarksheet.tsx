...
export function AcademicMarksheet({ marksheet, onChange, standard }: AcademicMarksheetProps) {
  ...
  const idPrefix = standard === "10th" ? "10" : "12";

  return (
    <Card>
      <CardContent className="p-6 space-y-4">
        <h3 className="text-lg font-medium">{standard} Standard Marksheet</h3>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <label htmlFor={`year${idPrefix}`} className="text-sm font-medium">Year</label>
            <Input
              id={`year${idPrefix}`}
              name="year"
          ...
          <div className="space-y-2">
            <label htmlFor={`board${idPrefix}`} className="text-sm font-medium">Board/University</label>
            <Input
              id={`board${idPrefix}`}
              name="board"
          ...
          <div className="space-y-2">
            <label htmlFor={`school${idPrefix}`} className="text-sm font-medium">School/Institution</label>
            <Input
              id={`school${idPrefix}`}
              name="school"
          ...
          <div className="space-y-2">
            <label htmlFor={`percentage${idPrefix}`} className="text-sm font-medium">Overall Percentage</label>
            <Input
              id={`percentage${idPrefix}`}
              name="percentage"
        ...
        <div className="pt-2">
          ...
          {marksheet.marks.map((mark, index) => (
            <div key={`${standard}-${index}`} className="grid grid-cols-12 gap-2 mb-2 items-center">
